...
function getPositionStyle(position) {
  ...
  style.innerHTML = `
      ...
      .notification-popup {
          ...
          position: fixed; bottom: 20px; right: 20px; padding: 16px; padding-right: 57px;
          background-color: #FFFFFF; border: 1px solid #E0E0E0; border-radius: 8px;
          box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); z-index: 9999; font-family: Arial, sans-serif;
          display: flex; flex-direction: column; align-items: start; max-width: 300px;
      }`;
...
`;
    ...
    messageText.style.cssText = "color: " + configDic.accentColor + "; font-size: 15px; line-height: 1.25; white-space: nowrap";
