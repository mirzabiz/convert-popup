...
const Hero = () => {
  return (
    <main className="text-center md:py-[140px] pt-[100px] pb-[120px] bg-[#e9f5f0] px-8">
      <div className="mb-4 ">
      ...
      <div className="flex flex-col gap-10 lg:gap-14 items-center justify-center text-center">
        ...
        <p className="md:text-lg text-sm opacity-80 leading-relaxed max-w-xl">
          Increase your conversion rate by showcasing recent sales with a popup users will trust, creating social proof and driving more sales.        </p>
