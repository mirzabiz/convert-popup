    ...
    <main className="text-center py-20 ">
      ...
      <div className="flex flex-col gap-10 lg:gap-14 items-center justify-center text-center ">
        ...
        <p className="text-lg opacity-80 leading-relaxed">
          ...
          Increase your sales easily by showing recent transactions in<br /> a popup users will trust.
        </p>
        <button className="btn btn-wide bg-[#02ad78] text-white rounded-[64px] hover:bg-[#02ad77c3] flex items-center justify-center">
